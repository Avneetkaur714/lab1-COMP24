...
*/
// VARIABLE DECLARATIONS
var customName = document.getElementById("customName"); // Input field has the id "customName"
var randomize = document.getElementById("randomize"); // Button has the id "randomize"
var story = document.getElementById("story"); //Paragraph has the id "story"
...
var storyText = 'Upon the fortuitous discovery of an overlooked epistolary gem within the confines of an antiquarian tome, she, perusing its contents, witnessed the resurgence of dormant emotions, prompting a resolute quest to locate the elusive author, yearning that the indelible ink of the missive had not succumbed to the inexorable march of time.';
...
var insertX = ['Elon Musk', 'Angelina Jolie', 'Sherlock Holmes'];
var insertY = ['The Louvre', 'Machu Picchu', 'The Maldives'];
var insertZ = ['unveiled groundbreaking technology', 'astounded onlookers with grace', 'solved an unsolvable mystery'];



// FUNCTIONS

/* STEP 2: have a look at the following function - if you call this function and pass it an array,
 it will return one of the elements of that array randomly */
function randomValueFromArray(array) {
    return array[Math.floor(Math.random() * array.length)];
}
var exampleArray = ["Option A", "Option B", "Option C"];
var randomElement = randomValueFromArray(exampleArray);
console.log(randomElement); // A random element from the exampleArray
...
function result() {
    ...
    if (document.getElementById("metric").checked) {
        ...
        var weight = Math.round(300 * 0.453592 * 10) / 10;
        ...
        var temp = Math.round((94 - 32) * (5 / 9) * 10) / 10;
